...
/* Observação: Como Estamos Trabalhando com OR e a Segunda condição é opcional colocamos na primeira Condição que tem mais 
Chances de Saída Verdadeira, pois a Segunda Condição não será Checada Nesse Caso.


/* O Gestor de Marketing pediu a Lista das Funcionárias que Trabalhem no Departamento de Filmes ou no Departamento Lar. Ele necessita 
enviar um email para as Colaboradoras desses Dois Setores */
SELECT
	NOME,
	SEXO,
	EMAIL
...
/* Tragas os Funcionários do Sexo Masculino ou os Funcionários que Trabalhem no Setor Jardim */
SELECT
	*
FROM
	FUNCIONARIOS
